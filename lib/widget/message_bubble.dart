...
class MessageBubble extends StatelessWidget {
  ...
  // Create a Message Bubble That continues The sequences
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  // the top.
                  if (isFirstSequence) const SizedBox(height: 18),
                  if (username != null)
                    Padding(
                  ...
                  Container(
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.only(
                        topLeft: !isMe && isFirstSequence
                            ? Radius.zero
                            : const Radius.circular(12),
                        topRight: isMe && isFirstSequence
                            ? Radius.zero
                            : const Radius.circular(12),
